...
import { VideoProbeTool } from './video_probe';
import { VideoDownloadTool } from './video_download';
import { VideoTranscriptTool } from './video_transcript';
...
export class ToolRegistry {
  ...
  private registerBuiltInTools(): void {
    ...
    this.register(new VideoProbeTool(this.context));
    this.register(new VideoDownloadTool(this.context));
    this.register(new VideoTranscriptTool(this.context));
